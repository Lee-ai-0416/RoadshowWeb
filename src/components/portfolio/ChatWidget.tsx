...
export const ChatWidget = () => {
  ...
  // 系统提示词 - 包含完整的项目信息和知识库
  const systemPrompt = `你是小Lee，一个独立开发者Lee的AI助手。你的任务是回答访客关于Lee的项目、AI编程经历和学习心得的问题。
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <Button
        ...
        className={`w-20 h-20 rounded-full shadow-2xl bg-gradient-to-r from-primary to-primary-glow hover:shadow-primary/50 hover:scale-110 transition-all relative ${
          showChat ? 'rotate-90' : 'animate-bounce-slow'
        }`}
      ...
      {showChat && (
        <div className="absolute bottom-20 right-0 w-96 bg-card rounded-2xl shadow-2xl border border-border overflow-hidden animate-in slide-in-from-bottom-4 duration-300">
          <div className="bg-gradient-to-r from-primary to-primary-glow p-4 flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-white font-semibold">小Lee</h3>
          ...
          <div ref={chatContainerRef} className="h-80 overflow-y-auto p-4 space-y-4 bg-secondary">
            <div className="flex items-start space-x-2">
              ...
              <div className="bg-card p-3 rounded-2xl rounded-tl-none shadow-sm max-w-[80%]">
                <p className="text-sm">嗨！我是小Lee 👋</p>
